...
<span class="label">Tecnico responsavel:</span><br>
...
Documento tecnico gerado em $data.
...
"@
        ...
        $confirmacao =
            [System.Windows.MessageBox]::Show(
                ...
                "Cliente: $($dados.Cliente)`n" +

                "Servico: $($dados.TipoServico)`n`n" +
